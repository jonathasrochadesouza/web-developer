...
export default function ListaLivro() {
  ...
  async function handleDeleteLivro(idlivro) {
    try {
        await api.delete(`book/${idlivro}`, {});
        setLivros(livros.filter(livro => livro.idlivro !== idlivro));
    } catch (error) {
...
//             <StyledTableCell  align="right">idlivro</StyledTableCell >
//           </TableRow>
//         </TableHead>
//         <TableBody>
//           {livros.map(livro => (
